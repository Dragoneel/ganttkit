...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@ganttkit/vue': resolve(__dirname, './packages/vue/src'),
      '@ganttkit/react': resolve(__dirname, './packages/react/src'),
      '@ganttkit/angular': resolve(__dirname, './packages/angular/src'),
